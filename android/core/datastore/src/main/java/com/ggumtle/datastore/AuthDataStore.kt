...
//        private val USER_EMAIL = stringPreferencesKey("user_email")
    ...
    val nicknameFlow: Flow<String?> = NICKNAME.flowIn(dataStore)
...
//    val userEmailFlow: Flow<String?> = USER_EMAIL.flowIn(dataStore)
    ...
    suspend fun saveNickname(nickname: String) = NICKNAME.saveTo(dataStore, nickname)
    suspend fun deleteNickname() = NICKNAME.deleteFrom(dataStore)
