...
public record PacketHeader(
    ...
    public static PacketHeader fromBytes(byte[] bytes) {
        ...
        short receivePacketType = buffer.getShort();
        int dataLength = buffer.getInt();
        long timestamp = buffer.getLong();

        return new PacketHeader(receivePacketType, dataLength, timestamp);
    }
    ...
    public byte[] toBytes() {
        ...
        buffer.putShort(receivePacketType);
