...
public enum FriendErrorCode implements ErrorCode {
    ...
    PARAMETER_REQUIRED(HttpStatus.BAD_REQUEST, "FR40002", "누락된 파라미터가 있습니다"),
    ...
    FRIEND_NOT_FOUND(HttpStatus.NOT_FOUND, "FR40403","친구 관계가 아닙니다"),

    DELETE_FRIEND_FORBIDDEN(HttpStatus.FORBIDDEN, "FR40301", "삭제할 권한이 없습니다")
    ;
