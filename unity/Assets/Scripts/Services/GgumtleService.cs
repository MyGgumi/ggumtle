...
//         // 꿈틀이 데이터 관리
//         private Dictionary<string, GgumtleData> ggumtleDataMap =
//             new Dictionary<string, GgumtleData>();
//         private Dictionary<string, Coroutine> feedingCoroutines =
...
//             {
//                 DebugLog(
//                     $"[GgumtleService] StartHold 불가능한 상태: {ggumtleId} - {data.currentState}"
//                 );
//             }
//         }
...
//                     DebugLog(
//                         $"[GgumtleService] 먹이 추가: {ggumtleId} ({data.currentFoodAmount}/{data.maxFoodRequired})"
//                     );
//                     OnGgumtleFoodAdded?.Invoke(
//                         ggumtleId,
//                         data.currentFoodAmount,
//                         data.maxFoodRequired
//                     );
...
//         /// </summary>
//         private System.Collections.IEnumerator TransitionToFeedingAfterDelay(
//             string ggumtleId,
//             float delay
//         )
//         {
...
//                 // TODO: 실제 서버 통신 구현
//                 DebugLog(
//                     $"[GgumtleService] 서버 전송 - 먹이주기: {ggumtleId}, 양: {data.currentFoodAmount}"
//                 );
//             }
//         }
...
//             {
//                 DebugLog(
//                     "[GgumtleService] UniversalHUDController 또는 NotificationViewModel을 찾을 수 없음"
//                 );
//             }
//         }
