...
public enum SocketType {
    ...
    GET_INVITATIONS("GET_INVITATIONS", "GET_INVITATIONS_RESULT"),
    GET_PARTY_PARTICIPANTS("GET_PARTY_PARTICIPANTS", "GET_PARTY_PARTICIPANTS_RESULT"),
    CHANGE_MONGGING("CHANGE_MONGGING", "CHANGE_MONGGING_RESULT"),
    ...
    CANCELLED_MATCHING("CANCELLED_MATCHING", "CANCELLED_MATCHING_RESULT"),
    ...
    GET_SENT_FRIEND_REQUESTS("GET_SENT_FRIEND_REQUESTS", "GET_SENT_FRIEND_REQUESTS_RESULT"),
    ...
    DELETE_FRIEND("DELETE_FRIEND", "DELETE_FRIEND_RESULT"),
    CANCLE_FRIEND_REQUEST("CANCLE_FRIEND_REQUEST", "CANCLE_FRIEND_REQUEST_RESULT"),
    ;
